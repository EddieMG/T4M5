...
from utils import MOTS_KITTI_Dataloader
from utils import MOTS_CATEGORIES
...
if __name__ == '__main__':
    ...
    #task_b_MOTS_training("MaskRCNN_R_50_FPN_COCO_MOTS", "COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml")
    #task_b_MOTS_training("MaskRCNN_R_50_FPN_COCO_Cityscape_MOTS", "COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml")
    #task_b_MOTS_and_KITTI_training("MaskRCNN_R_50_FPN_COCO_MOTS_KITTI", "COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml")
    task_b_MOTS_and_KITTI_training("MaskRCNN_R_50_FPN_COCO_Cityscape_MOTS_KITTI_WarmupCosineLR", "COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml")
